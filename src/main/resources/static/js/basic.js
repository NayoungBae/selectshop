    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            for(let i=0; i<response.length; i++) {
                let itemDto = response[i]; //하나의 DTO
...
function addProduct(itemDto) {
     ...
     */
    /** 주의!!) 파라미터를 받을 때 파라미터가 JSON 형태면 JS가 알아서 JSON으로 변환함!!!
     *         참고로 파라미터 itemDto는 stringify함수를 거친 결과인 문자열임 **/
    ...
    $.ajax({
        ...
        data: JSON.stringify(itemDto), /* 데이터는 무조건 string이여야함!! */
        success: function(response) {
